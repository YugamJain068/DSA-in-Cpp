...
int *z;
 z = &UNIVERSAL;
     ...
     while(temp!=NULL)
     {
         if((strcmp(temp->aadhar,"10001")==0&& strcmp(temp->name,"Raghav Dhir")==0 &&strcmp(temp->birth_date,"07-12-2004")==0) ||
         (strcmp(temp->aadhar,"10002")==0&& strcmp(temp->name,"Anshuman Dadwal")==0 &&strcmp(temp->birth_date,"24-06-2004")==0)||
         (strcmp(temp->aadhar,"10003")==0&& strcmp(temp->name,"Rakshit ")==0 &&strcmp(temp->birth_date,"27-09-2003")==0)||
         (strcmp(temp->aadhar,"10004")==0&& strcmp(temp->name,"vipul Kumar Sharma")==0 &&strcmp(temp->birth_date,"08-12-1999")==0)||
         (strcmp(temp->aadhar,"10005")==0&& strcmp(temp->name,"Jatin ")==0 &&strcmp(temp->birth_date,"06-06-2004")==0)||
         (strcmp(temp->aadhar,"10006")==0&& strcmp(temp->name,"Banshtu ")==0 &&strcmp(temp->birth_date,"03-05-2000")==0)||
